...
export class SignatureInfoViewViewProvider extends BaseViewViewProvider implements vscode.WebviewViewProvider {
	...
	public static readonly viewType = 'sigsView.signatureinfo';

	protected readonly _pinnedContext = 'sigsView.signatureInfoView.isPinned';
	...
	private updateConfiguration() {
		const config = vscode.workspace.getConfiguration('sigsView');
